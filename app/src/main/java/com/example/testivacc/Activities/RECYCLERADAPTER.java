...
public class RECYCLERADAPTER extends RecyclerView.Adapter<com.example.testivacc.Activities.RECYCLERADAPTER.MyViewHolder> {
    String data1[],data2[];
    int images[];
    Context context;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            myText1=itemView.findViewById(R.id.textView6);
